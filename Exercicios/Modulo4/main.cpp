...
// Parâmetros da luz e material para Phong
...
// Fragment shader implementando iluminação Phong + textura
...
int main()
{
    ...
    // Uniform locations para parâmetros Phong
    ...
    // Configuração inicial dos coeficientes e parâmetros da luz
...
Geometry loadGeometry(const char* filepath)
{
    ...
    // Reserve espaço para 11 floats por vértice: pos(3), color(3), uv(2), normal(3)
    ...
    // Atualizar os ponteiros para refletir 11 floats por vértice
